...
data_root = '/datasets/public/COCOSearch18/TP/fixations'
...
os.makedirs('/datasets/public/COCOSearch18/TP/processed', exist_ok=True)
save_json_file = '/datasets/public/COCOSearch18/TP/processed/fixations.json'
